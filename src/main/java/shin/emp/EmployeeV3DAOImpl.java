...
@Repository("empv3dao")
public class EmployeeV3DAOImpl implements EmployeeV3DAO {
    ...
    public ArrayList<EmployeeVO> readEMP() {
    ...
    public EmployeeVO readOneEMP(int inputid) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        EmployeeVO ev = new EmployeeVO();
    ...
    public String deleteSQL(int empid) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        conn = EmployeeJDBC.makeConn();
        String result = "실패!";
    ...
    public String modifySQL(EmployeeVO ev) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        String result = "실패!";
        conn = EmployeeJDBC.makeConn();
